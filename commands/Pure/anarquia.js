...
module.exports = {
	...
	async execute(request, args, isSlash = false) {
		...
		if(!(isSlash ? args.data : args).length) {
			...
			const tableY = ctx.measureText('M').emHeightDescent + 24 + 16; //Por alguna razón, el measureText ha de tener medidas diferentes en local y Heroku, así que agrego un +9
