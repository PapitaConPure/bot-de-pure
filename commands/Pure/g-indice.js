...
module.exports = {
	...
	desc: `Esta es la página de introducción de Bot de Puré. Si estás tan confundido como para no saber del todo cómo usar \`${p_pure}ayuda\`, esto puede serte útil\n\n` +
		...
		'Referencia:\n' +
		`\`${p_pure}ayuda g-parametros\`: introducción a \`<parámetros>\`\n` +
		`\`${p_pure}ayuda g-opciones\`: introducción a opciones y \`--banderas\`\n` +
		`\`${p_pure}ayuda g-tipos\`: introducción a _(tipos)_ y definiciones de _(tipos)_\n\n` +
