...
async function Wea(msg) {
const servidor = msg.channel.guild; //Variable que almacena un objeto del servidor a analizar
	...
	servidor.channels.forEach(channel => {
		if(channel.type === 'text') {
			msgcnt[textcnt] = await channel.messages.array().length;
	...
	const Embed2 = new Discord.RichEmbed()
		...
		.setFooter(`Comando invocado por ${msg.author.username}`, msg.author.avatarURL)
