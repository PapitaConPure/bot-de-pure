...
module.exports = {
	...
	async execute(request, args, isSlash = false) {
		...
		let list = [
			...
			'CyWCpFFovw0', 'gK7dszd_j1c', 'J9IM6KcO7qk', 'XctAezJ_OEc', '2D4tdy8b2dM', 'WrJFBmxHXuY', 'h4ioYorKqYo', 'pZOHMxAOXro', 'noXWHJVMrJg',
		...
		if(showtotal) {
			m = new Discord.MessageEmbed()
				...
				.addField('Subgrupo especial', (hint)?(list.length - xmusic):'No hay subgrupos especiales ahora mismo...', true);
		...
		else if(i < xmusic) //Música """conocida"""
