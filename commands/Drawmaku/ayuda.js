...
module.exports = {
	...
	execute(message, args) {
        message.channel.send(
            ...
            `\t\`${global.p_drmk}danmaku ||<danmaku*>||\` para ingresar el nombre de tu danmaku ***(¡no olvides las \\|\\|barras verticales\\|\\|!)***.\n` +
            `\t\`${global.p_drmk}danmaku <imagen adjunta del danmaku*>\` para ingresar el dibujo de tu danmaku ***(se tiene que adjuntar el dibujo junto al comando)***.\n` +
