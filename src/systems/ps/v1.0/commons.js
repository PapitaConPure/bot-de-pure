...
/**@typedef {import('./util').ValuesOf<LanguageDataTypes>} LanguageDataType*/
//#endregion
...
/**@typedef {import('./util').ValuesOf<typeof ParserStatementNodeTypes>} ParserStatementNodeType*/
...
/**@typedef {import('./util').ValuesOf<typeof ParserDataNodeTypes>} ParserDataNodeType*/
...
/**@typedef {import('./util').ValuesOf<typeof ParserLiteralNodeTypes>} ParserLiteralNodeType*/
...
/**@typedef {import('./util').ValuesOf<typeof ParserExpressionNodeTypes>} ParserExpressionNodeType*/

const ParserSpecialNodeTypes = /**@type {const}*/({
	Program:             'Program',
});
/**@typedef {import('./util').ValuesOf<typeof ParserSpecialNodeTypes>} ParserSpecialNodeType*/
...
/**@typedef {import('./util').ValuesOf<typeof ParserNodeTypes>} ParserNodeType*/
...
function isParserNode(node) {
	//@ts-expect-error Comprobación de tipo
