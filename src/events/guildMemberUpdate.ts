import { EmbedBuilder, Guild, GuildMember, PartialGuildMember, User } from 'discord.js';
import { globalConfigs } from '../data/globalProps';
import userIds from '../data/userIds.json';
import { channelIsBlocked } from '@/func';

const guildBotUpdateText: Map<'dibujarBienvenida' | 'dibujarDespedida', (member: GuildMember | PartialGuildMember) => string> = new Map();
guildBotUpdateText
...
export function announceMemberUpdate<TMember extends GuildMember | PartialGuildMember>(member: TMember, fn: (member: TMember) => unknown) {
