...
async function handleCommand(interaction: ChatInputCommandInteraction<'cached'>, stats: StatsDocument) {
...
async function handleAction(interaction: ContextMenuCommandInteraction<'cached'>, stats: StatsDocument) {
	const { commandName } = interaction;
