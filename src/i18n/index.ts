...
const localesObject = {
	...
	voiceSessionMemberEditTransferAdminMemberDesc: {
		es: 'El administrador de la sesión puede renombrarla, congelarla y descongelarla, así como también puede expulsar o readmitir miembros y designar moderadores.',
		en: 'The session administrator can rename, freeze, and unfreeze the session, as well as ban or unban members and designate moderators.',
		ja: 'セッション管理者は、セッション名の変更、セッションの凍結および凍結解除、メンバーの追放および追放解除、モデレーターの指名を行うことができます。',
	},
	...
	voiceSessionMemberEditGuestDesc: {
		es: 'Puede unirse a la sesión mientras no sea congelada en su ausencia.',
		en: "Can join the session as long as it's not frozen while they're away.",
		ja: '離席中にセッションがフリーズしなければ、セッションに参加できます。',
	},
	voiceSessionMemberEditWhitelistedLabel: {
		es: 'Invitado (lista blanca) ❄️',
		en: 'Guest (Whitelisted) ❄️',
		ja: 'ゲスト（ホワイトリスト） ❄️',
	},
	voiceSessionMemberEditWhitelistedDesc: {
		es: 'Puede unirse a la sesión incluso si fue congelada.',
		en: "Can join the session even when it's frozen.",
		ja: 'セッションがフリーズしている状態でも、セッションに参加できます。',
	},
	...
	voiceSessionMemberEditModDesc: {
		es: 'Puede renombrar, congelar y descongelar la sesión, así como expulsar o readmitir miembros invitados.',
		en: 'Can rename, freeze, and unfreeze the session, as well as ban or unban guest members.',
		ja: 'セッション名の変更、セッションの凍結・凍結解除、およびゲストメンバーの参加禁止・禁止解除を行うことができます。',
	},
	...
	voiceSessionMemberEditBannedDesc: {
		es: 'No puede unirse a la sesión bajo ninguna circunstancia.',
		en: 'Cannot join the session under any circumstance.',
		ja: 'いかなる状況においても、そのセッションに参加することはできません。',
	},
