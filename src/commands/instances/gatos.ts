...
const command = new Command(
	...
	.setLongDescription('Muestra imágenes de gatitos.', 'Fuente: https://cataas.com')
		...
		const container = new ContainerBuilder()
			...
			.addMediaGalleryComponents((mediaGallery) =>
				mediaGallery.addItems((mediaGalleryItem) =>
					mediaGalleryItem.setDescription('🐈').setURL(catUrl),
				),
			)
			.addTextDisplayComponents((textDisplay) => textDisplay.setContent('## 🥺 Gatitos'));
