...
/**Representa un Lexer de PuréScript*/
class Lexer {
    ...
    constructor() {
        ...
        this.#keywords = [
            { match: 'verdadero', kind: TokenKinds.BOOLEAN, value: true },
            { match: 'falso', kind: TokenKinds.BOOLEAN, value: false },
            ...
            { match: 'numero', kind: TokenKinds.KIND_NUMBER },
            { match: 'texto', kind: TokenKinds.KIND_TEXT },
            { match: 'dupla', kind: TokenKinds.KIND_BOOLEAN },
        ...
        this.#patterns = [
            ...
            { match: /^(([0-9][0-9,_]*[0-9])|[0-9])(\.(([0-9][0-9,_]*[0-9])|[0-9]))?/, handler: this.#makeNumberHandler() },
    ...
    #makeNumberHandler() {
        ...
        return function(matched) {
            ...
            lexer.addToken(new Token(TokenKinds.NUMBER, num, lexer.line, lexer.col, len));
            lexer.advance(len, { advanceColumns: true });
        };
    }
    ...
    #makeStringHandler() {
        ...
        return function(match, rawMatch) {
            ...
            lexer.addToken(new Token(TokenKinds.STRING, rawMatch, lexer.line, lexer.col, len));
