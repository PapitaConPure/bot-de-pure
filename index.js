...
function modifyAct(step) {
    switch(step) {
        ...
        case 24: client.user.setActivity("-_-", { type: 'STREAMING', url: 'https://www.youtube.com/watch?v=h_3ULXom6so' }); break;
        case 25: client.user.setActivity("=_=", { type: 'STREAMING', url: 'https://www.youtube.com/watch?v=h_3ULXom6so' }); break;
    }
