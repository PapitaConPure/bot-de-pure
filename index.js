        ...
        if(channel.id === pv.voiceMakerId) {
            try {
                ...
                await Promise.all([
                    ...
                    sessionTextChannel.setTopic(`${guild.name}» PuréVoice » ${member.user.tag}\nCanal de texto de Sesión\n ¡Conéctate a <#${channel.id}> para conversar aquí!`).catch(prematureError),
                ]);
